    ...
    throws ServletException, IOException {
        ...
        try {
           //Recogemos variables que son enviadas desde Index.jsp
            ...
            String [] datos=Sql.getFila("SELECT p.idpersona,p.Apellidos,p.Nombres,u.usuario,u.rol FROM persona p INNER JOIN usuario u ON p.idpersona=u.persona_idpersona WHERE u.usuario='"+usuario+"' AND u.contrasena='"+contra+"'");
